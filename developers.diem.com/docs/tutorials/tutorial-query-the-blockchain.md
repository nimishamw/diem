...
#### Prerequisites
* Complete the [My first transaction](doc:tutorial-my-first-transaction) tutorial to understand how to create accounts and interact with testnet.
...
* [Account address: Hex-coded account address](doc:tutorial-my-first-transaction#step-4-optional-list-accounts)
